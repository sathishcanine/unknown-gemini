...
def main():
    parser = argparse.ArgumentParser(description="History Practice Question Generator")
    ...
    facts_path = "/Users/sathishkumar/Pictures/Ai-Demos/Q-Gemini/Indian-History/history_facts.json"
    ...
    print(f"Total questions in History database: {len(all_db_qs)}")
