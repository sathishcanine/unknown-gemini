...
def main():
    parser = argparse.ArgumentParser(description="TNPSC Polity PYQ Transcriber")
    ...
    parser.add_argument("--topic", type=str, required=True, help="Topic name (e.g., 'Constitution of India')")
    ...
    pdf_path = "/Users/sathishkumar/Pictures/Ai-Demos/Q-Gemini/Data/Indian-History-Data/INDIAN HISTORY PYQ PDF 2020 -2025.pdf"
    db_path = "/Users/sathishkumar/Pictures/Ai-Demos/Q-Gemini/Indian-History/history_questions_db.json"
    ...
    print(f"Starting Polity PYQ transcription for topic '{args.topic}' across physical pages {args.start} to {args.end}...")
    ...
    for page_num in range(args.start, args.end + 1):
        ...
        temp_img_path = f"/Users/sathishkumar/Pictures/Ai-Demos/Q-Gemini/Indian-History/temp_page_{page_num}.png"
