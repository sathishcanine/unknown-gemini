...
DB_PATH = os.path.join(ROOT_DIR, "Chemistry", "chemistry_questions_db.json")
...
def main():
    ...
    if not os.path.exists(DB_PATH):
        print(f"Error: Chemistry question database not found at {DB_PATH}")
        return
    ...
    print(f"Loaded {len(questions)} Chemistry questions from JSON. Importing to DB...")
