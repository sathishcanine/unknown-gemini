#!/usr/bin/env python3
"""Import Tamil Unit 3 Ezhuthum Thiran / Marabu Tamil practice questions into Postgres."""
...
DB_PATH = os.path.join(ROOT_DIR, "Tamil", "ezhuthum_thiran_questions_db.json")
...
def main():
    ...
    if not os.path.exists(DB_PATH):
        print(f"Error: Unit 3 question database not found at {DB_PATH}")
        return
    ...
    print(f"Loaded {len(questions)} Unit 3 questions from JSON. Importing to DB...")
