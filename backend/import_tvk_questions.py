...
DB_PATH = os.path.join(ROOT_DIR, "TVK", "tvk_questions_db.json")

SUBJECT_ID = "TVK"
SUBJECT_NAME = "TVK-Government Policies"
SUBJECT_NAME_TA = "த.வெ.க அரசு கொள்கைகள்"
SUBJECT_ICON = "🏛️"
...
def main():
    ...
    if not os.path.exists(DB_PATH):
        print(f"Error: TVK question database not found at {DB_PATH}")
        return
    ...
    print(f"Loaded {len(questions)} TVK questions from JSON. Importing to DB...")
